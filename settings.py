...
DATABASES = {
    'default': {
        ...
        'NAME': '/opt/yocto/fsl-community-bsp/sources/buildhistory-web/bhtest.db3',                      # Or path to database file if using sqlite3 (full path recommended).
...
ALLOWED_HOSTS = [u'aws-dey-builder']
